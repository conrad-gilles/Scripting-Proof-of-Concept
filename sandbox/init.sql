...
CREATE TABLE customer_scripts (
    ...
    min_api_version INT NOT NULL,   -- From [ScriptMetadata] attribute
...
CREATE TABLE script_compiled_cache (
    ...
    -- script_name VARCHAR(100),
    api_version INT,
    assembly_bytes BYTEA,  --change this to allow null so you can save even if failed, then obviously dont save the assembly bytes
    compilation_date TIMESTAMP NOT NULL,
    compilation_success BOOLEAN NOT NULL,
    compilation_errors TEXT,        -- JSON array if failed
...
CREATE TABLE ember_instances (
    ...
    ember_version VARCHAR(20) NOT NULL, -- "2.3.0"
    sdk_version INT NOT NULL,           -- 2    
