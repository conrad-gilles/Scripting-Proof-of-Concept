...
internal class ScriptManager(
    ...
    ILogger<ScriptManager> _logger,
    IUserSession _userSession) : IScriptManager, IScriptManagerExtended
{
    ...
    {
        _logger.LogDebug("Entered {MethodName} in {ClassName} apiVersion: {apiVersion}.", nameof(CreateScript), nameof(ScriptManager), apiVersion);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with scriptId: {ScriptId}.", nameof(UpdateScript), nameof(ScriptManager), scriptId);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with Name: {name}.", nameof(UpdateScript), nameof(ScriptManager), name);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with ID: {scriptId}.", nameof(UpdateScriptAndCompile), nameof(ScriptManager), scriptId);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with Name: {name}.", nameof(UpdateScriptAndCompile), nameof(ScriptManager), name);
        Guid scriptId = await GetScriptId<ScriptType>(name);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with scriptId: {ScriptId}.", nameof(DeleteScript), nameof(ScriptManager), scriptId);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with scriptName: {scriptName}.", nameof(DeleteScript), nameof(ScriptManager), scriptName);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with scriptId: {ScriptId}.", nameof(GetScript), nameof(ScriptManager), scriptId);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with Name: {name}.", nameof(GetScript), nameof(ScriptManager), name);
        Guid scriptId = await GetScriptId<ScriptType>(name);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName}.", nameof(ListScripts), nameof(ScriptManager));
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with scriptId: {ScriptId} and targetApiVersion: {TargetApiVersion}.", nameof(CompileScript), nameof(ScriptManager), scriptId, targetApiVersion);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName}.", nameof(CompileAllScripts), nameof(ScriptManager));
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName}.", nameof(CreateScriptWithoutCompiling), nameof(ScriptManager));
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with scriptId: {ScriptId}.", nameof(RecompileAllCaches), nameof(ScriptManager), scriptId);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with scriptId: {ScriptId}.", nameof(RecompileCache), nameof(ScriptManager), scriptId);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with scriptId: {ScriptId}.", nameof(GetCompilationErrors), nameof(ScriptManager), scriptId);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName}", nameof(TryCompile), nameof(ScriptManager));
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName}.", nameof(GetCompilationErrors), nameof(ScriptManager));
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with scriptId: {ScriptId}.", nameof(GetCompiledCache), nameof(ScriptManager), scriptId);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with scriptId: {ScriptId}.", nameof(ClearScriptCache), nameof(ScriptManager), scriptId);
        await _db.ClearScriptCache(scriptId);
    }

    public async Task DeleteScriptCache(Guid id, int apiVersion)
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with ApiVersion: {ScriptId}.", nameof(DeleteScriptCache), nameof(ScriptManager), apiVersion);
        await _db.DeleteScriptCache(id, apiVersion);
    }

    public async Task<List<CompiledScript>> GetAllCompiledScriptCaches()
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName}.", nameof(GetAllCompiledScriptCaches), nameof(ScriptManager));
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName}.", nameof(ClearAllCaches), nameof(ScriptManager));
        await _db.DeleteAllCachedScripts();
    }

    public async Task DeleteAllData()
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName}.", nameof(DeleteAllData), nameof(ScriptManager));
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName}.", nameof(GetRunningApiVersion), nameof(ScriptManager));
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with scriptId: {ScriptId}.", nameof(GetScriptCompatibility), nameof(ScriptManager), scriptId);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with scriptId: {ScriptId}.", nameof(CheckVersionCompatibility), nameof(ScriptManager), scriptId);
        try
        {
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with instanceId: {InstanceId}.", nameof(RegisterEmberInstance), nameof(ScriptManager), instanceId);
        // TODO
    }
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with scriptId: {ScriptId}.", nameof(GetScriptExecutionHistory), nameof(ScriptManager), scriptId);
        // TODO
    }
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName}.", nameof(GetCompilationStatistics), nameof(ScriptManager));
        // TODO
    }
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName}.", nameof(HealthCheck), nameof(ScriptManager));
        // TODO
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName} with scriptId: {ScriptId}.", nameof(GetScriptMetadata), nameof(ScriptManager), scriptId);
    ...
    {
        _logger.LogTrace("Entered {MethodName} in {ClassName}.", nameof(GetUserSession), nameof(ScriptManager));
        return _userSession;
    }
