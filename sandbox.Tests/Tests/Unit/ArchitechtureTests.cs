...
public class ArchitechtureTests
{
    ...
    public async Task CheckTimeout()
    {
        ...
        {
            await InternalScriptManager.ExecuteUnfinishedScriptBySourceCode(sourceCode5000, TestHelper.GetContext(), nameof(RecentIActionScript.ExecuteAsync));
        });
        stopwatch.Stop();
       ...
       {
           await InternalScriptManager.ExecuteUnfinishedScriptBySourceCode(sourceCode100, TestHelper.GetContext(), nameof(RecentIActionScript.ExecuteAsync));
       });
        stopwatch.Stop();
        ...
        e = await Assert.ThrowsExceptionAsync<ActionScriptExecutionException>(async () =>
       {
           await InternalScriptManager.ExecuteUnfinishedScriptBySourceCode(sourceCode500, TestHelper.GetContext(), nameof(RecentIActionScript.ExecuteAsync));
       });
        stopwatch.Stop();
        ...
        e = await Assert.ThrowsExceptionAsync<ActionScriptExecutionException>(async () =>
       {
           await InternalScriptManager.ExecuteUnfinishedScriptBySourceCode(sourceCode1000, TestHelper.GetContext(), nameof(RecentIActionScript.ExecuteAsync));
       });
        stopwatch.Stop();
