...
public class SecurityTests
{
    ...
    public async Task WhileTrueScript()
    {
        await Assert.ThrowsExceptionAsync<ActionScriptExecutionException>(async () =>
        {
            ...
            RecentActionResult ar = (RecentActionResult)await InternalScriptManager!.ExecuteScript<IActionScript>("WhileTrueScript", ctx, nameof(IExecuteAsync.ExecuteAsync));
